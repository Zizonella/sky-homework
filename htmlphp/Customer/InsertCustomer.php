...
if (isset($_POST['first_name']) && ($_POST['last_name']) && ($_POST['email']) && ($_POST['password']) && ($_POST['mailing_list'])){
    ...
    $sql = 'INSERT INTO customer(first_name, last_name, email, password, mailing_list) VALUES(:Fname, :Lname, :email, :pass, :Mlist)';
    $statement = $conn->prepare($sql);
    
    if ($statement->execute([':Fname'=>$fName, ':Lname'=>$lName, ':email'=>$email, ':pass'=>$password,':Mlist'=>$mList])){
...
<div class="container">
    <div class="card">
    <h3 class="card-header text-center font-weight-bold text-uppercase py-4">Insert Customer</h3>
        ...
        <div class="container">
            ...
            <form method="post">
                <div class="form-group row col-auto">
                    <label for="first-name" class="col-sm-2  col-form-label-sm">First Name</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control form-control-sm" id="first-name" name="first_name">
                    </div>
                </div>
                <div class="form-group row col-auto">
                    <label for="last-name" class="col-sm-2  col-form-label-sm">Last Name</label>
                    <div class="col-sm-10">
                ...
                <div class="form-group row col-auto">
                    ...
                    <div class="form-group row ">
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="mailing_list" id="inlineRadio1" value="true">
                            <label class="form-check-label" for="inlineRadio1">IN</label>
                          </div>
                            <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="mailing_list" id="inlineRadio2" value="false">
                            <label class="form-check-label" for="inlineRadio2">OUT</label>
                            </div>
                    </div>
                <div class="row">
                    <div class="col-sm btn-lg">
                        <input type="submit" value="Create New Listing Type" class="btn btn-danger btn-rounded btn-sm my-0 text-center col-auto float-right" id="btn-colour"/>
                    </div>
                </div>
