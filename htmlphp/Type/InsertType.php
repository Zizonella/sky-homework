...
if (isset($_POST['type'])){
    $type = $_POST['type'];
    $sql = 'INSERT INTO listing_type( type) VALUES(:type)';
...
<div class="card">
    <h3 class="card-header text-center font-weight-bold text-uppercase py-4">Create New Listing Type</h3>
    ...
    <div class="card-body"> 
            ...
            <form method="post">
                <div class="form-group row col-auto">
                    <label for="first-name" class="col-sm-2  col-form-label-sm">Listing Type</label>
                    <div class="col-sm-10">
                ...
                <div class="row">
                    <div class="col-sm btn-lg">
                        <input type="Submit" name="Submit" value="Submit" class="btn btn-danger btn-rounded btn-sm my-0 text-center col-auto float-right" id="btn-colour"/>
                    </div>
                </div>
